    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex gap-8">
          {NAV_LINKS.map(({ label, href }) => (
            <Link
              key={href}
              href={href}
              className={`group relative px-2 py-1 text-sm font-medium transition-all duration-300
                ${isActive(href) 
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            ...
            >
              ...
              {cartItemCount > 0 && (
                <>
                  ...
                  {/* Badge */}
                  <span className={`absolute -top-1 -right-1 h-5 w-5 text-xs flex items-center justify-center bg-gradient-to-br from-red-500 to-red-600 text-white rounded-full font-bold shadow-sm transition-transform duration-300 ${
                    cartOpen ? "scale-125" : ""
                  }`}>
                    {cartItemCount}
                  </span>
            ...
            <div
              ...
              className={`
                ...
                bg-gradient-to-b from-white to-gray-50/30 rounded-3xl 
            ...
            >
              {/* Edge Glow Effect */}
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#5A1E12]/60 via-[#EAD7B7]/40 to-[#5A1E12]/60" />
          ...
          <Link
            href="/signup"
            className="relative overflow-hidden rounded-full bg-gradient-to-r from-[#5A1E12] to-[#7A2E1F] px-8 py-2.5 text-white font-medium shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95 group"
          >
            <span className="relative z-10">Sign Up</span>
            {/* Hover effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#7A2E1F] to-[#5A1E12] translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
          </Link>
