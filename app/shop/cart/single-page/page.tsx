...
//             <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden group">
...
//                       <div 
//                         key={i} 
//                         className="w-8 h-8 rounded-full border-2 border-white bg-gradient-to-r from-blue-400 to-purple-500"
//                       />
//                     ))}
//                   </div>
//                   <div>
...
//                   </motion.button>
//                   <span className="px-6 py-4 text-lg font-bold min-w-[3rem] text-center">
//                     {quantity}
//                   </span>
//                   <motion.button
//                     whileTap={{ scale: 0.9 }}
