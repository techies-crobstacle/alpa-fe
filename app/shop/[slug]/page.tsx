...
//           {/* Image Section */}
//           <div className="space-y-4">
//             <div className="relative aspect-square w-140 bg-white rounded-2xl overflow-hidden shadow-lg border border-amber-200">
...
//                 className={`flex-1 py-3 px-6 rounded-lg font-semibold transition shadow-md ${
//                   addedToCart
