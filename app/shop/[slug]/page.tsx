                ...
                <div className="relative">
                  ...
                  {showShareMenu && (
                    <>
                      ...
                      {/* Dropdown */}
                      <div className="absolute right-0 bottom-16 z-50 w-56 bg-white rounded-2xl shadow-2xl border border-[#973c00]/10 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-[#EAD7B7]/40 transition-colors"
                        >
                          {linkCopied ? (
                            <Check className="w-4 h-4 text-emerald-600 shrink-0" />
                          ) : (
                            <svg className="w-4 h-4 shrink-0 text-[#5A1E12]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                          )}
                          <span className={linkCopied ? 'text-emerald-600 font-semibold' : ''}>
                        ...
                        <a
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-[#EAD7B7]/40 transition-colors"
                        >
                          <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                          X (Twitter)
                        </a>
                      </div>
                    </>
