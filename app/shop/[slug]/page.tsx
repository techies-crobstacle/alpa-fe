...
//         {isModalOpen && (
//           <div
//             className="fixed inset-0 z-100 bg-black/96 backdrop-blur-md animate-in fade-in duration-200"
//             onClick={() => setIsModalOpen(false)}
//           >
//             <button
//               onClick={() => setIsModalOpen(false)}
//               className="absolute top-4 right-4 p-3 bg-white/10 hover:bg-white/20 text-white rounded-full transition-all duration-200 hover:scale-110 z-110"
//             >
//               <X className="w-6 h-6" />
//             </button>
//             {allImages.length > 1 && (
...
//                 className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 text-white rounded-full transition-all duration-200 hover:scale-110 z-110"
//               >
...
//                 className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 text-white rounded-full transition-all duration-200 hover:scale-110 z-110"
//               >
...
//             <div className="absolute inset-x-0 top-0 bottom-16 flex items-center justify-center px-4 sm:px-8 md:px-12">
//               <div
...
//                   quality={100}
//                   sizes="(max-width: 640px) calc(100vw - 32px), (max-width: 1024px) calc(100vw - 96px), 1024px"
//                 />
//               </div>
//             </div>
...
//             {allImages.length > 1 && (
//               <div
//                 className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2.5 px-4 py-2.5 bg-white/5 backdrop-blur-xl rounded-2xl overflow-x-auto max-w-[90vw] z-110"
//                 onClick={(e) => e.stopPropagation()}
//               >
//                 {allImages.map((img, idx) => (
//                   <button
